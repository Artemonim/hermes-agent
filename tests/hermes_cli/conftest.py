...
def isolated_update_runtime(monkeypatch, tmp_path, request):
    ...
    monkeypatch.setattr(main, "_fleet_probe_expected_runtimes", lambda *a, **kw: False)
    ...
    monkeypatch.setattr(update_inventory, "report_unaccounted_runtimes", lambda *a, **k: False)
