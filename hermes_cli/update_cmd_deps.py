...
def _update_node_dependencies() -> list[str]:
    ...
    #
    # `--progress=false` still leaves npm silent for 8–10 minutes on a cold
    # workspace install. Heartbeat so the Desktop idle watchdog (600s of no
    # stdout AND no update.log growth → exit 124) does not kill a healthy update.
