...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("reasoning", "Manage reasoning effort and display", "Configuration",
               ...
               desktop="advanced"),
    CommandDef("fast", "Fast mode — Priority Processing / Anthropic Fast Mode / OpenRouter flex (normal/fast/flex/auto/cold)", "Configuration",
               args_hint="[normal|fast|flex|auto|cold|status] [--global]",
               subcommands=("normal", "fast", "flex", "auto", "cold", "status", "on", "off", "priority", "--global"),
               desktop="advanced"),
