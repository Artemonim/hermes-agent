...
CONFIGURABLE_TOOLSETS = [
    ...
    ("audio",           "🎧 Audio / Soundtrack Listen", "audio_analyze"),
...
#: Audio listen shipped after some saved ``platform_toolsets`` lists were frozen.
#: ``audio_analyze`` is ``check_fn``-gated, so an enabled toolset still ships zero
#: schemas when the check fails. Probe no remote service from this path.
