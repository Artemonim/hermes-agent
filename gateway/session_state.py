...
class PersistentState:
    ...
    native_audio_paths: List[str] = field(default_factory=list)  # current-turn-only inline clips
    native_video_frame_paths: List[str] = field(default_factory=list)  # ephemeral sampled stills
...
LEGACY_FIELD_SPECS: Dict[str, _FieldSpec] = {
    ...
    "_pending_native_video_frame_paths_by_session": _spec("persistent", "native_video_frame_paths", list),
