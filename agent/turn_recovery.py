...
def recover_before_classification(
    ...
    _looks_like_audio_rejection = False
    try:
        from agent.audio_routing import looks_like_audio_content_rejection

        _looks_like_audio_rejection = looks_like_audio_content_rejection(_err_body)
    except Exception:
        pass
    if _looks_like_audio_rejection and _status_ok:
        ...
        _vlines(
            agent,
            "⚠️  Server rejected native audio — continuing with transcript/path notes only"
