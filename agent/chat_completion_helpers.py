...
def build_api_kwargs(agent, api_messages: list, tools_for_api: list | None = None) -> dict:
    ...
    # already pinned in agent.request_overrides; auto/cold windows and
    # fork-local OpenRouter tier / TTFT overlays layer here per request.
    _request_overrides = _effective_request_overrides(agent)
